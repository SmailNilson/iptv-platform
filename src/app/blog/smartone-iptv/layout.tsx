...
export const metadata: Metadata = {
    title: "SmartOne IPTV : Le Guide Ultime d'Installation 2026 (Tous Appareils)",
    description: "Guide complet pour installer et configurer SmartOne IPTV en 2026 sur Smart TV Samsung, LG, Fire Stick, Android TV. Configuration Xtream Codes pas à pas.",
    ...
    openGraph: {
        title: "SmartOne IPTV : Le Guide Ultime d'Installation 2026",
    ...
    twitter: {
        ...
        title: "SmartOne IPTV : Guide Complet 2026",
