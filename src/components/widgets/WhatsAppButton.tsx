...
const WHATSAPP_NUMBER = '17575357760';
const WHATSAPP_MESSAGE = 'Bonjour, je suis intéressé par vos offres IPTV.';
        ...
        <>
            ...
            {showTooltip && (
                <div className={styles.tooltip} onClick={handleClick}>
                    ...
                    <div className={styles.tooltipTitle}>💬 Une question ?</div>
                    <div className={styles.tooltipText}>
                        Notre équipe répond en <strong>moins de 5 min</strong> !
                    </div>
